...
const Graphs = ({ tasks }) => {
  useEffect(() => {
    ...
    const legend = barSvg
      .append("g")
      .attr("transform", `translate(${barWidth - margin.right - 150}, 10)`);
      ...
      {tasks.length === 0 ? (
        <Box>
          ...
          <Typography variant="body1" sx={{ textAlign: "center" }}>
            Once tasks are added, graphs will appear here to show the priority distribution
